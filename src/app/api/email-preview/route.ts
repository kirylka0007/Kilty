...
// Preview-only route — shows what the confirmation email looks like in a browser.
// Remove this file before going to production or restrict access as needed.
export async function GET() {
  const fullName = "Anna Petrova";
  const firstName = "Anna";
  const city = "Edinburgh";
  const eventDate = "Saturday 25 April 2026";
  const eventTime = "19:00";
  const venue = "Radisson Blu Royal Mile";
